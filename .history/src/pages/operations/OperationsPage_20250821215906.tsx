...
const OperationPage = () => {
  ...
  {/* No timeline/leaderboard/irrelevant elements for pure marketing impact */}
        ...
        <div className="text-center mt-20 animate-fade-in">
          ...
          <button className="btn-primary px-16 py-6 text-2xl font-black flex items-center gap-4 shadow-xl animate-pulse-slow transition-transform hover:scale-105 border-2 border-accent-blue/40">
