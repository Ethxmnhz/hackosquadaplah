...
// Particle SVG background (cyber style)
const Particles = () => (
  <svg className="absolute inset-0 w-full h-full z-0 pointer-events-none" style={{ opacity: 0.18 }}>
    <defs>
      <radialGradient id="cyberGlow" cx="50%" cy="50%" r="80%">
        <stop offset="0%" stopColor="#7f5af0" stopOpacity="0.7" />
        <stop offset="100%" stopColor="#0A030F" stopOpacity="0" />
      </radialGradient>
    </defs>
    <circle cx="20%" cy="30%" r="120" fill="url(#cyberGlow)" />
    <circle cx="80%" cy="60%" r="90" fill="url(#cyberGlow)" />
    <circle cx="60%" cy="80%" r="60" fill="url(#cyberGlow)" />
    <circle cx="40%" cy="20%" r="70" fill="url(#cyberGlow)" />
    <circle cx="70%" cy="40%" r="50" fill="url(#cyberGlow)" />
  </svg>
);
...
const OperationPage = () => {
  return (
  <div className="relative min-h-screen text-white overflow-hidden" style={{ background: 'radial-gradient(ellipse at 60% 20%, #1a1033 0%, #0A030F 100%)' }}>
  ...
  <div className="absolute inset-0 z-0 pointer-events-none">
        <video
          ...
          loop
          muted
          className="w-full h-[38vh] min-h-[420px] object-cover brightness-[.28]"
        />
  ...
  <Particles />
      ...
      <div className="relative z-10 pt-24 pb-12 px-2 sm:px-6 max-w-6xl mx-auto">
        ...
        <div className="absolute left-0 top-32 z-0 opacity-40 animate-pulse-slow">
          <Bomb className="w-32 h-32 text-red-900/60" />
        </div>
        <div className="absolute right-0 top-60 z-0 opacity-40 animate-pulse-slow">
          <ShieldOff className="w-32 h-32 text-blue-900/60" />
        </div>
        {/* Hero Section */}
  <div className="text-center mb-16 relative z-10">
          ...
          <h1 className="text-6xl font-black tracking-tight mb-6 bg-gradient-to-r from-red-400 via-primary to-blue-400 text-transparent bg-clip-text drop-shadow-[0_2px_24px_rgba(127,90,240,0.25)]">
  ...
  <div className="bg-background-light/90 rounded-2xl p-10 border border-primary/20 shadow-2xl mb-20 flex flex-col md:flex-row items-center gap-10 animate-fade-in">
