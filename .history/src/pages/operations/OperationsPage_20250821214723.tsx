...
const OperationPage = () => {
  ...
  <div className="relative min-h-screen text-white overflow-hidden" style={{ background: 'radial-gradient(ellipse at 60% 20%, #181024 0%, #0A030F 100%)' }}>
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        <video
          ...
          loop
          muted
          className="w-full h-[38vh] min-h-[320px] object-cover brightness-[.22]"
          style={{ filter: 'blur(1.5px) grayscale(0.2)' }}
        />
        <div className="absolute inset-0 bg-gradient-to-b from-black/90 via-[#0A030F]/90 to-[#0A030F]/98" />
      </div>
  ...
  <div className="text-center mb-16 relative z-10">
          ...
          <div className="flex justify-center mb-6">
            <span className="px-5 py-2 rounded-full bg-gradient-to-r from-primary to-accent-blue text-white text-lg font-bold tracking-widest shadow-lg animate-pulse-slow border border-primary/40" style={{letterSpacing:'0.18em'}}>LIVE</span>
          </div>
          <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto mb-8 animate-fade-in font-light">
            <span className="text-primary font-semibold">Mission Briefing:</span> Enter a real-time cyber operation. Attack, defend, and master real-world skills in a live, team-based arena. Every move counts. Every second is tracked. Are you ready?
          </p>
          <div className="flex flex-wrap justify-center gap-4 mt-6 animate-fade-in">
            <button className="btn-primary flex items-center gap-2 px-10 py-5 text-xl font-bold shadow-xl transition-transform hover:scale-105 focus:scale-105">
              <Play className="h-7 w-7" /> Start Operation
            </button>
            <button className="btn-outline flex items-center gap-2 px-10 py-5 text-xl font-bold border-primary text-primary hover:bg-primary/10 transition-transform hover:scale-105 focus:scale-105">
  ...
  <div className="bg-background-light/80 rounded-2xl p-10 border border-primary/30 shadow-2xl mb-20 flex flex-col md:flex-row items-center gap-10 animate-fade-in backdrop-blur-md" style={{boxShadow:'0 0 32px #7f5af055, 0 2px 32px #0A030Fcc'}}>
          ...
          <div className="flex-1 flex flex-col items-center justify-center">
            <div className="bg-gradient-to-br from-primary/30 to-background-dark rounded-2xl p-8 border border-primary/30 shadow-xl w-full max-w-xs backdrop-blur-md" style={{boxShadow:'0 0 24px #7f5af055, 0 2px 24px #0A030Fcc'}}>
  ...
  <div className="mb-20 animate-fade-in">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {benefits.map((benefit, idx) => (
              <div key={idx} className="bg-background-dark/80 rounded-2xl border border-primary/20 p-10 flex flex-col items-center shadow-xl hover:scale-[1.03] transition-transform backdrop-blur-md" style={{boxShadow:'0 0 16px #7f5af055, 0 2px 16px #0A030Fcc'}}>
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-8">
            {howItWorks.map((step, idx) => (
              <div key={idx} className="relative flex flex-col items-center md:items-start text-center md:text-left">
                <div className="bg-background-dark border-2 border-primary/40 rounded-full p-5 mb-4 shadow-lg backdrop-blur-md" style={{boxShadow:'0 0 12px #7f5af055, 0 2px 12px #0A030Fcc'}}>
                  {step.icon}
                </div>
