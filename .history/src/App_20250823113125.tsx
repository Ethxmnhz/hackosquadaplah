...
// Team Pages
import RedVsBlueHomePage from './pages/redvsblue/RedVsBlueHomePage';
...
import MatchmakingPage from './pages/redvsblue/MatchmakingPage';
        ...
        <Routes>
          ...
          <Route element={<AuthGuard />}>
            <Route element={<DashboardLayout />}>
              ...
              <Route path="/red-vs-blue" element={<RedVsBlueHomePage />} />
