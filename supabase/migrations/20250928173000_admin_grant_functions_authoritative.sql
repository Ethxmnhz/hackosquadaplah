-- Migration: Authoritative definition of admin grant functions
-- Timestamp: 2025-09-28 17:30:00
-- Purpose: Resolve repeated 'function already exists' errors caused by earlier conditional drop predicates
-- Strategy: Unconditionally DROP IF EXISTS using compact argument list (no space sensitivity) then CREATE
