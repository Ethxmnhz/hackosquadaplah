...
const OperationsManagementPage = () => {
  ...
  const filteredOperations = activeOperations.filter(operation => {
    const matchesSearch = operation.lab?.title?.toLowerCase().includes(searchTerm.toLowerCase()) ||
                         operation.red_profile?.username?.toLowerCase().includes(searchTerm.toLowerCase()) ||
                         operation.blue_profile?.username?.toLowerCase().includes(searchTerm.toLowerCase());
      ...
      >
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            ...
            <p className="text-gray-400">Control and monitor live red team vs blue team operations</p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                      ...
                      <div className="space-y-4">
                        <div className="flex items-center p-3 bg-primary/10 rounded-lg border border-primary/20">
                          <Sword className="h-5 w-5 text-primary mr-3" />
                          <div>
                            <div className="text-xs text-gray-400">Red Team</div>
                            <div className="text-sm text-white font-medium">{operation.red_profile?.username}</div>
                          </div>
                          <div className="ml-auto text-lg font-bold text-primary">{operation.red_team_score}</div>
                        </div>
                        
                        <div className="flex items-center p-3 bg-accent-blue/10 rounded-lg border border-accent-blue/20">
                          <Shield className="h-5 w-5 text-accent-blue mr-3" />
                          <div>
                            <div className="text-xs text-gray-400">Blue Team</div>
                            <div className="text-sm text-white font-medium">{operation.blue_profile?.username}</div>
                          </div>
                          <div className="ml-auto text-lg font-bold text-accent-blue">{operation.blue_team_score}</div>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="flex flex-col justify-between p-3 bg-background-light rounded-lg">
                          <div className="text-xs text-gray-400">Flags Captured</div>
            ...
            >
              ...
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <Card className="p-4">
                    <h4 className="text-lg font-bold text-white mb-4">Team Info</h4>
                    <div className="space-y-4">
                      <div className="p-3 bg-primary/10 rounded-lg border border-primary/20">
                        <div className="flex items-center">
                          <Sword className="h-5 w-5 text-primary mr-2" />
                          <span className="text-sm text-gray-400">Red Team</span>
                        </div>
                        <div className="mt-1 flex justify-between">
                          <span className="text-white">{selectedOperation.red_profile?.username}</span>
                          <span className="text-primary font-bold">{selectedOperation.red_team_score} pts</span>
                        </div>
                      </div>
                      ...
                      <div className="p-3 bg-accent-blue/10 rounded-lg border border-accent-blue/20">
                        <div className="flex items-center">
                          ...
                          <span className="text-sm text-gray-400">Blue Team</span>
                        </div>
                        <div className="mt-1 flex justify-between">
                          <span className="text-white">{selectedOperation.blue_profile?.username}</span>
                          <span className="text-accent-blue font-bold">{selectedOperation.blue_team_score} pts</span>
                        </div>
                      </div>
                    </div>
                  </Card>
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div className="p-3 bg-background-light rounded-lg">
                        <div className="text-sm text-gray-400 mb-1">Flags Captured</div>
                        <div className="text-xl font-bold text-primary">{selectedOperation.flags_captured}</div>
                      </div>
                      
                      <div className="p-3 bg-background-light rounded-lg">
                        <div className="text-sm text-gray-400 mb-1">Attacks Blocked</div>
                        <div className="text-xl font-bold text-accent-blue">{selectedOperation.attacks_blocked}</div>
                      </div>
